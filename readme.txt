...
Major refactoring changes in options handling.
...
* *Easy WP LaTeX Lite* uses the excellent Javascript color picker by [Javascript Color Picker] (http://jscolor.com "Javascript Color Picker").
